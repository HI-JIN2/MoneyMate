...
public class GoalSettingActivity extends AppCompatActivity {
    ...
    private Button btnGoalSettingComplete;
    ...
    private void checkEditTextInputs() {
        ...
        // 필요한 조건을 여기에 추가할 수 있습니다.
        // 예를 들어, 모든 필수 입력 필드가 비어 있지 않을 때 버튼을 활성화할 수 있습니다.
